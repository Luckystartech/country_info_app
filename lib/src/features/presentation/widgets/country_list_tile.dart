  ...
  Widget build(BuildContext context) {
    return ListTile(
      ...
      leading: Container(
        ...
        height: Sizes.p48,
        decoration:
            BoxDecoration(borderRadius: BorderRadius.circular(Sizes.p8)),
        child: Image.network(
          country.flag.pngUrl,
          fit: BoxFit.cover,
        ),
      ...
      title: Text(
        ...
        style: context.textTheme.bodyLarge!.copyWith(
            fontWeight: FontWeight.w400, color: context.colorScheme.primary),
      ),
      subtitle: Text(
        country.capital,
        style: context.textTheme.bodySmall!.copyWith(
            fontWeight: FontWeight.w100, color: context.colorScheme.primary),
      ),
    );
  }
}
