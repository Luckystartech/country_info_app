...
import 'package:country_info_app/src/features/presentation/widgets/app_logo.dart';
import 'package:country_info_app/src/theme/toggle_theme_icon.dart';
    ...
    return SafeArea(
      child: AppBar(
        toolbarHeight: MediaQuery.sizeOf(context).height *
            0.3, // Optional: Customize the height
